...
async () => {
    ...
    return battleContract;
          ...
          console.log(data);
        //   setBattleContract(data);
            // setBatt(tokenContract);
              });
...
//     const commitHash = await battleContract.methods.createCommitment(address, `["2", "3", "4"]`, "0x626c696e64303100000000000000000000000000000000000000000000000000").call();
...
// Bowlf is hidden when it hits the ground
  ...
  addButton("Reveal", vec2( width() / 3 , height() / 1.1), () => {
    console.log("Player 1 reveals")
  })
});
